...
> **Public Alpha · v0.4.2** — developer release. The CLI is the primary supported interface; the desktop app is experimental and Linux-first. Eutrya has automated regression coverage, but it has **not** undergone an independent security audit.
...
Version: **0.4.2**. Node.js **22+**. Linux-first; tested here on Linux with Node 22.16.0.
