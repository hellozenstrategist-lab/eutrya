...
export const ACTION_HELP = {
  ...
  delegate: 'Delegate a task to a specialized agent in the swarm: {type:"delegate",to:"engineer",task:"..."}',
  send_message: 'Send a message or review request to another agent: {type:"send_message",to:"legal",message:"..."}',
